...
//    //private static TaskItemDetailDto MapTask(TaskItem t) => new()
//    //{
//    //    Name = t.Name,
...
//    private static PersonDetailDto MapPerson(Person p) => new()
//    {
...
//        => Ok((await _tasks.GetAllAsync()).Select(TaskItemSummaryMapper.toDto).ToList());

//    [HttpGet("tasks/{id}")]
//    public async Task<ActionResult<TaskItemDetailDto>> GetTaskItem(int id)
//    {
//        var item = await _tasks.GetByIdAsync(id);
//        return item is null ? NotFound() : Ok(TaskItemDetailMapper.toDto(item));
//    }
...
//        return CreatedAtAction(nameof(GetTaskItem), new { id = created.Id }, TaskItemDetailMapper.toDto(created));
//    }
...
//        return updated is null ? NotFound() : Ok(TaskItemDetailMapper.toDto(updated));
//    }

//    [HttpDelete("tasks/{id}")]
//    public async Task<ActionResult<TaskItemDetailDto>> DeleteTaskItem(int id)
//    {
//        var deleted = await _tasks.DeleteAsync(id);
//        return deleted is null ? NotFound() : Ok(TaskItemDetailMapper.toDto(deleted));
//    }
...
//    public async Task<ActionResult<PersonDetailDto>> DeletePerson(int id)
//    {
...
//    public async Task<ActionResult<List<TaskToolDto>>> GetTaskTools(int taskId)
//        => Ok((await _taskTools.GetToolsByTaskAsync(taskId))
//            .Select(TaskToolMapper.toDto).ToList());
